...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Blog>|Blog whereBanner($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Blog>|Blog whereMetaTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Blog>|Blog whereMetaImg($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Blog>|Blog whereVideoUrl($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Blog>|Blog whereBannerAlt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Code>|Code whereCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Code>|Code whereCountry($value)
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereBrand($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereModelNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereOtp($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereEmailVerifiedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereCountryCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry wherePhoneNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereServiceSlug($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CustomerInquiry>|CustomerInquiry query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class CustomerInquiry extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
