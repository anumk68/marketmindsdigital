        ...
        <div class="col-md-6 mx-auto">
            <div class="login-container">
                <div class="login-logo-sec text-center">
                    <img src="<?php echo e(asset('public/images/resources/Printer(2).webp')); ?>"  style="width:175px"
                        alt="logo icon">
                </div>
        ...
        document.getElementById('auth-form').addEventListener('submit', async function (e) {
            ...
            try {
                if (isForgotPassword) {
                    ...
                    if (!otpStage) {
                        const response = await fetch("<?php echo e(route('forgot.password.send.otp')); ?>", {
                            method: "POST",
                            headers: {
                        ...
                        // Reset Password
                        const response = await fetch("<?php echo e(route('forgot.password.reset')); ?>", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-TOKEN": document.querySelector('input[name=_token]').value,
                        ...
                        const response = await fetch("<?php echo e(route('forgot.password.verify.otp')); ?>", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-TOKEN": document.querySelector('input[name=_token]').value,
                    ...
                    try {
                        const response = await fetch("<?php echo e(route('send.otp')); ?>", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-TOKEN": document.querySelector('input[name=_token]').value,
                    ...
                    const route = isRegister ? "<?php echo e(route('verify.register')); ?>" : "<?php echo e(route('verify.login')); ?>";
...
</html><?php /**PATH C:\xampp\htdocs\digital_marketing_4website_from_anumam_with_backend\resources\views/admin/login.blade.php ENDPATH**/ ?>