<?php $__env->startSection('content'); ?>
    ...
    <section class="page-header">
        <div class="page-header-bg"
            style="background-image: url(<?php echo e(asset('public/frontend/assets/images/backgrounds/asian-male-hand-using-mobile-phone-using-credit-card-pay-credit-card-payment-concept_104677-1472.jpg')); ?>)">
        </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketingmindsdigital\MarketingMindsDigital.com\smartwebelevate.com\resources\views/frontend/refund-policy.blade.php ENDPATH**/ ?>