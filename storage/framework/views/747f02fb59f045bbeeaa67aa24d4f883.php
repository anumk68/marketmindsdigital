<?php $__env->startSection('title',' Marketing Minds Digital | About Us'); ?>
<?php $__env->startSection('meta_description',' Learn about Marketing Minds Digital, a leading USA-based agency offering SEO, PPC, social
...
<section class="page-header">
    <div class="page-header-bg"
        style="background-image: url(<?php echo e(asset('public/frontend/assets/images/backgrounds/man-face-portrait-banner-with-copy-space-two-angry-businessmen-arguing-having-struggle-leadership-misunderstanding_545934-71.jpg')); ?>)">
    </div>
            ...
            <div class="col-xl-5">
                <div class="benefits-one__left">
                    <div class="benefits-one__img wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                        <img src="<?php echo e(asset('public/frontend/assets/images/resources/marketing-computer-sign-symbol-concept_53876-123885.jpg')); ?>"
                            alt="">
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\marketingmindsdigital\MarketingMindsDigital.com\smartwebelevate.com\resources\views/frontend/about.blade.php ENDPATH**/ ?>