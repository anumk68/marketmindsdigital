    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="<?php echo e(route('meta.list')); ?>">
                        ...
                        <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:void(0);">
                                        <img src="<?php echo e(asset('public/admin/assets/images/county/01.png')); ?>" width="20"
                                            alt="">
                                        <span class="ms-2">English</span></a>
                                </li>

                                <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:void(0);">
                                        <img src="<?php echo e(asset('public/admin/assets/images/county/03.png')); ?>" width="20"
                                            alt="">
...
<?php /**PATH C:\xampp\htdocs\marktingminds7novserver\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>